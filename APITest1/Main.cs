...
<tns:Envelope xmlns:tns=""http://schemas.xmlsoap.org/soap/envelope/"">
  <tns:Body />
            ...
            _flow.StServiceCallActivity4.IconPath = @"AddIns\ServiceTest\WSImportTechnology\toolbox_SOAP_request.png";
            _flow.StServiceCallActivity4.Name = @"invokeWebService (RPC/Encoded)4";
            _flow.StServiceCallActivity4.TransportProtocol.SOAPProperties.EndpointAddress = String.IsNullOrEmpty(_context.ResourceManager.GetValue(@"{Step.GeneralProperties.StServiceCallActivity4.TransportProtocol.SOAPProperties.EndpointAddress}")) ? @"http://ecomt200.dev.qintra.com:7622/FulfillmentWFMDWWeb/MDWWebService" : _context.ResourceManager.GetValue(@"{Step.GeneralProperties.StServiceCallActivity4.TransportProtocol.SOAPProperties.EndpointAddress}");
            ...
            _flow.StServiceCallActivity4.Service = @"MDWWebService";
            _flow.StServiceCallActivity4.Port = @"MDWWebServicePort";
            _flow.StServiceCallActivity4.Operation = @"invokeWebService";
            ...
            _flow.StServiceCallActivity4.TargetNamespace=@"http://mdw.qwest.com/listener/webservice";
